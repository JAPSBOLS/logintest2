                    ...
                    <table>
                        ...
                        <tbody>
                            <tr align="left">
                                <!-- Thematic Area -->
                                <td>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic1" name="Thematic1"/>
                                        <label for="Thematic1">Environment and Natural Resources Systems Management and Development</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic2" name="Thematic2"/>
                                        <label for="Thematic2">Climate Change Adaptation and Disaster Risk Reduction</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic3" name="Thematic3"/>
                                        <label for="Thematic3">Socio-Economics, Culture and Arts and Governance</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic4" name="Thematic4"/>
                                        <label for="Thematic4">Health Systems Management and Development</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic5" name="Thematic5"/>
                                        <label for="Thematic5">Gender and Development</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic6" name="Thematic6"/>
                                        <label for="Thematic6">Inclusive Education and Lifelong Learning</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic7" name="Thematic7"/>
                                        <label for="Thematic7">Food & Nutrition Security and Poverty Reduction</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Thematic8" name="Thematic8"/>
                                ...
                                <!-- Course  -->
                                <td>
                                    <div class="checkbox-container"><input type="checkbox" id="BEEd" name="BEEd"/>
                                        <label for="BEEd">Bachelor of Elementary Education</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSAT" name="BSAT"/>
                                        <label for="BSAT">Bachelor of Science in Automotive Technology</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSCpE" name="BSCpE"/>
                                        <label for="BSCpE">Bachelor of Science in Computer Engineering</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSCS" name="BSCS"/>
                                        <label for="BSCS">Bachelor of Science in Computer Science</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSECE" name="BSECE"/>
                                        <label for="BSECE">Bachelor of Science in Electronics Engineering</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSET" name="BSET"/>
                                        <label for="BSET">Bachelor of Science in Electronics Technology</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSEntrep" name="BSEntrep"/>
                                        <label for="BSEntrep">Bachelor of Science in Entrepreneurship</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSIS" name="BSIS"/>
                                        <label for="BSIS">Bachelor of Science in Information System</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSIT" name="BSIT"/>
                                        <label for="BSIT">Bachelor of Science in Information Technology</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSITa" name="BSITa"/>
                                        <label for="BSITa">Bachelor of Science in Information Technology (Animation)</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSMT" name="BSMT"/>
                                        <label for="BSMT">Bachelor of Science in Mechanical Technology</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSN" name="BSN"/>
                                        <label for="BSN">Bachelor of Science in Nursing</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSEde" name="BSEde"/>
                                        <label for="BSEde">Bachelor of Secondary Education Major in English</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BSEdm" name="BSEdm"/>
                                        <label for="BSEdm">Bachelor of Secondary Education Major in Math</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BTLEdi" name="BTLEdi"/>
                                        <label for="BTLEdi">Bachelor of Technology and Livelihood Education Major in ICT</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="BTLEdh" name="BTLEdh"/>
                                ...
                                <!-- Thesis Category -->
                                <td>
                                    <div class="checkbox-container"><input type="checkbox" id="Research" name="Research"/>
                                        <label for="Research">Research</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Development" name="Development"/>
                                        <label for="Development">Development</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="RnD" name="RnD"/>
                                ...
                                <!-- Reserve  -->
                                <td>
                                    <div class="checkbox-container"><input type="checkbox" id="Available" name="Available"/>
                                        <label for="Available">Available</label>
                                    </div>
                                    <div class="checkbox-container"><input type="checkbox" id="Unavailable" name="Unavailable"/>
