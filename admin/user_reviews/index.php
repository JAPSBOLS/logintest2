    ...
    <div id="content">
        ...
        <?php include(GROOT.'includes/topbar.php');?>
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Users Reviews</h1>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            // SQL query to count reviews for each rating
                            ...
                            if ($ratings_count_result->num_rows > 0) {
                                ...
                                while ($row = $ratings_count_result->fetch_assoc()) {
                                    ...
                                    echo "<div class='progress-bar bg-success' role='progressbar' style='width: " . ($rating_count / $total_reviews * 100) . "%' aria-valuenow='" . ($rating_count / $total_reviews * 100) . "' aria-valuemin='0' aria-valuemax='100'></div>";
                                    echo "</div>";
                                    echo "</li>";
                                    $total_stars += $rating * $rating_count;
                                    $total_ratings_count += $rating_count;
                                }
                                echo "</ul>";
                            } else {
                            ...
                            if ($total_reviews > 0) {
                                ...
                                echo "<span class='numerical-value'> (" . number_format($average_rating, 2) . ")</span>";
                                echo "</div>";
                            }
